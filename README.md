...
| Pip          | Python package manager      | `sudo pacman -S python-pip`| `sudo apt install python3-pip`| `sudo dnf install python3-pip`| `sudo zypper install python3-pip` | `apk add py3-pip`| `nix-env -iA nixos.python3.pkgs.pip` | `emerge pip`    | `winget install Python.Python.3.13`/`scoop install python`/`choco install python` | `pkg install python`   |
...
- [Python](https://www.python.org/downloads/) - [Python.org](www.python.org)
