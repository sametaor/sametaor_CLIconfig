...
// And functions
export function pairToTuple (p: Pair): Tuple {
...
let ints = [0, 1, 2, 3, 4]  // will infer as Array
let floats: f32[] = [0, 1, 2, 3, 4]  // will infer as Array
let doubles = [0.0, 1.0, 2, 3, 4]  // will infer as Array
let bytes1 = [0 as u8, 1, 2, 3, 4]  // will infer as Array
let bytes2 = [0, 1, 2, 3, 4]  as u8[] // will infer as Array
let bytes3: u8[] = [0, 1, 2, 3, 4] // will infer as Array
