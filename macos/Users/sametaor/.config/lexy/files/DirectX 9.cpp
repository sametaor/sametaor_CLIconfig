...
ComPtr _vertexBuffer{ };
// Lets define a function to calculate the byte size of a std::vector
template 
unsigned int GetByteSize(const std::vector& vec) {
...
IDirect3DVertexBuffer9* CreateBuffer(const std::vector& vertices) {
...
IDirect3DIndexBuffer9* CreateIBuffer(std::vector& indices) {
