...
in
{
  ...
  environment = {
    ...
    shellAliases = {
      ...
      "susc-lsu" = "sudo systemctl list-units";
      "susc-iact" = "sudo systemctl is-active";
      "susc-status" = "sudo systemctl status";
      "susc-show" = "sudo systemctl show";
      "susc-help" = "sudo systemctl help";
      "susc-lsuf" = "sudo systemctl list-unit-files";
      "susc-ien" = "sudo systemctl is-enabled";
      "susc-lsj" = "sudo systemctl list-jobs";
      "susc-showenv" = "sudo systemctl show-environment";
      "susc-cat" = "sudo systemctl cat";
      "susc-lst" = "sudo systemctl list-timers";
      "susc-start" = "sudo systemctl start";
      "susc-stop" = "sudo systemctl stop";
      "susc-reload" = "sudo systemctl reload";
      "susc-restart" = "sudo systemctl restart";
      "susc-trystart" = "sudo systemctl try-restart";
      "susc-iso" = "sudo systemctl isolate";
      "susc-kill" = "sudo systemctl kill";
      "susc-repass" = "sudo systemctl reset-failed";
      "susc-en" = "sudo systemctl enable";
      "susc-dis" = "sudo systemctl disable";
      "susc-reen" = "sudo systemctl reenable";
      "susc-pre" = "sudo systemctl preset";
      "susc-mask" = "sudo systemctl mask";
      "susc-unmask" = "sudo systemctl unmask";
      "susc-link" = "sudo systemctl link";
      "susc-load" = "sudo systemctl load";
      "susc-cancel" = "sudo systemctl cancel";
      "susc-setenv" = "sudo systemctl set-environment";
      "susc-unsetenv" = "sudo systemctl unset-environment";
      "susc-edit" = "sudo systemctl edit";
      "susc-ennow" = "sudo systemctl enable --now";
      "susc-disnow" = "sudo systemctl disable --now";
      "susc-masknow" = "sudo systemctl mask --now";
    };
    systemPackages =
      with pkgs;
      [
