    ...
    fastfetch = {
      ...
      settings = {
        ...
        "display" = {
          ...
          "separator" = " [38;2;54;248;236m⟫[38;0m ";
        };
        "logo" = {
          "type" = "kitty";
          "source" = "~/Projects/github/sametaor_CLIconfig/linux/NixOS/home/sametaor/.config/fastfetch/Logo.png";
          "width" = 40;
          "padding" = {
            "right" = 3;
          };
        ...
        "modules" = [
          ...
          {
            "type" = "custom";
            "format" = " {$8}{$1}{$7}{$10}{$1}▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔{$5}{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}{$1}{$7}{$10}{$1}{$7}  [38;2;102;187;255m█▀▀▀▀ ▀▀▀▀█ █▀▀▀▀ ▀▀█▀▀ █▀▀▀▀ █▀▀▀█ ▀▀█▀▀ █▀▀▀▀ █ ▀ █{$7}  {$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}{$3}{$7} {$10}{$3}{$7}   [38;2;145;125;221m█▀▀▀▀ █▀▀▀█ ▀▀▀▀█ ▀ █ ▀ █▀▀▀▀ █▀▀▀▀ ▀ █ ▀ █ ▀ ▀ █▀▀▀█{$7}  {$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$10}▏{$7}   [38;2;188;63;188m▀ ▀ ▀ ▀▀▀▀▀ ▀▀▀▀▀ ▀ ▀ ▀ ▀ ▀ ▀ ▀▀▀▀▀ ▀ ▀ ▀ ▀▀▀▀▀ ▀ ▀ ▀{$7}  {$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$10}▏{$7}   ─────────────────────────────────────────────────────  {$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "title";
            "format" = "{$8}▏{$7} {$10}▏{$7}                    {6} {7} {8}[105G{$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}{$7}[38;2;151;128;220m{$7}{$10}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{$7}[38;2;151;128;220m{$7}{$8}{$7}";
          }
          {
            "type" = "host";
            "key" = "[38;2;247;7;203mHost  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;247;7;203m▏[38;0m   [38;2;247;7;203m󰪫[38;0m";
            "format" = "{2}[105G{$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "os";
            "key" = "[38;2;247;7;203mOS    ";
            "keyIcon" = "[38;2;54;248;236m◺[0m [38;2;247;7;203m◺[38;0m   [38;2;247;7;203m󰌢[38;0m";
            "format" = "{3}[105G{$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "kernel";
            "key" = "[38;2;247;7;203mKernel";
            "keyIcon" = "[38;2;54;248;236m◹◺[0m[38;2;247;7;203m◹◺[38;0m  [38;2;247;7;203m󰒓[38;0m";
            "format" = "{1} {4}[105G{$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "shell";
            "key" = "[38;2;247;7;203mShell ";
            "keyIcon" = "[38;2;254;247;9m[38;2;54;248;236m◹[0m [38;2;247;7;203m◹[38;0m  [38;2;247;7;203m[38;0m";
            "format" = "{6} - TTY {8}[105G{$10}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "packages";
            "combined" = true;
            "key" = "[38;2;247;7;203mPkgs  ";
            "keyIcon" = "[38;2;254;247;9m█ [38;2;54;248;236m▏[0m [38;2;247;7;203m▏[38;0m [38;2;247;7;203m[38;0m";
            "format" = "{53}[105G{$10}{$6}{$7} {$8}▕{$7}";
          }
          {
            "type" = "uptime";
            "key" = "[38;2;247;7;203mUptime";
            "keyIcon" = "[38;2;254;247;9m▐ [38;2;54;248;236m▏[0m [38;2;247;7;203m▏[38;0m [38;2;247;7;203m󱦟[38;0m";
            "format" = "{1}d {2} ={3} ={4}[104G{$10}{$1}{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$9}▐{$7} {$8}▏{$7} {$10}{$4}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$1}{$7}{$9}◢{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$9}▐{$7} {$8}▏{$7} {$11}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$7}   {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$9}▐{$7} {$8}▏{$7}{$11}▕{$7}  {$8}󰇅 Hardware{$7}                                           {$11}{$2}{$7}{$9}◥{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$9}▐{$7} {$8}{$7}[38;2;116;126;241m[38;0m{$11}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┅{$2}{$7} {$8}▕{$7}";
          }
          {
            "type" = "cpu";
            "temp" = true;
            "key" = "[38;2;177;3;246mCPU   ";
            "keyIcon" = "[38;2;254;247;9m█ [38;2;54;248;236m▏[0m[38;2;177;3;246m▕[38;0m  [38;2;177;3;246m[38;0m";
            "format" = "{1}[105G{$11}{$5}{$7} {$8}▕{$7}";
          }
          {
            "type" = "memory";
            "key" = "[38;2;177;3;246mMem   ";
            "keyIcon" = "[38;2;254;247;9m[38;2;54;248;236m◿[0m [38;2;177;3;246m◿[38;0m  [38;2;177;3;246m[38;0m";
            "format" = "{1}/{2} {4}[105G{$11}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "disk";
            "key" = "[38;2;177;3;246mDisk  ";
            "keyIcon" = "[38;2;54;248;236m◿◸[0m[38;2;177;3;246m◿◸[38;0m  [38;2;177;3;246m󰋊[38;0m";
            "format" = "{20} - {1}/{2} - {9}[105G{$11}▕{$7} {$8}▕{$7}";
            "folders" = "/";
          }
          {
            "type" = "gpu";
            "temp" = true;
            "key" = "[38;2;177;3;246mGPU   ";
            "keyIcon" = "[38;2;54;248;236m◸[0m [38;2;177;3;246m◸[38;0m   [38;2;177;3;246m󰢮[38;0m";
            "format" = "{1}™ {2} {4}[105G{$11}▕{$7} {$8}▕{$7}";
            "hideType" = "integrated";
          }
          {
            "type" = "battery";
            "temp" = true;
            "key" = "[38;2;177;3;246mBatt  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;177;3;246m◺[38;0m   [38;2;177;3;246m[38;0m";
            "format" = "{1} ({4} {10})[105G{$11}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "display";
            "key" = "[38;2;177;3;246mDisp  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;177;3;246m◹◺[38;0m  [38;2;177;3;246m󰹑[38;0m";
            "format" = "{1}x{2} @{3}Hz[105G{$11}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$9}◣{$7}{$11}{$2}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$6}{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7}   {$12}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$7} {$8}▕{$7}";
          ...
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$9}◤{$7}{$12}◿◸{$7} {$8} Software{$7}                                             {$12}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$12}{$1}┅━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{$7}[38;2;151;190;128m[38;0m{$8}{$7}";
          }
          {
            "type" = "wm";
            "detectPlugin" = true;
            "key" = "[38;2;248;132;20mWM    ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;248;132;20m◸[38;0m   [38;2;248;132;20m󱂬[38;0m";
            "format" = "{2}[105G{$12}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "lm";
            "key" = "[38;2;248;132;20mLM    ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;248;132;20m▏[38;0m   [38;2;248;132;20m󰍂[38;0m";
            "format" = "{1} @ {2}[105G{$12}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "theme";
            "key" = "[38;2;248;132;20mTheme ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;248;132;20m▏[38;0m   [38;2;248;132;20m󰔎[38;0m";
            "format" = "{2}[105G{$12}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "terminal";
            "key" = "[38;2;248;132;20mTerm  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;248;132;20m▏[38;0m   [38;2;248;132;20m[38;0m";
            "format" = "{5}[105G{$12}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "icons";
            "key" = "[38;2;248;132;20mIcons ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;248;132;20m◺[38;0m   [38;2;248;132;20m[38;0m";
            "format" = "{1}{2}[105G{$12}{$6}{$7} {$8}{$6}{$7}";
          }
          {
            "type" = "font";
            "key" = "[38;2;248;132;20mFont  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;248;132;20m◹◺[38;0m  [38;2;248;132;20m󰛖[38;0m";
            "format" = "{5}[104G{$12}{$1}{$7}{$8}{$1}{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$9}◣{$7}{$12}{$2}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$1}{$7} {$8}{$3}{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7}   {$13}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$7} {$8}▕{$7}";
          ...
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$9}◤{$7}{$13}{$1}{$7} {$8} Misc{$7}                                               {$13}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$13}{$1}┅━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{$7}[38;2;84;245;210m[38;0m{$8}{$7}";
          }
          {
            "type" = "datetime";
            "key" = "[38;2;114;241;184mDate  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;114;241;184m◸[38;0m   [38;2;114;241;184m[38;0m";
            "format" = "{1}.{3}.{23}[103G{$13}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "datetime";
            "key" = "[38;2;114;241;184mTime  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;114;241;184m▏[38;0m   [38;2;114;241;184m[38;0m";
            "format" = "{14}:{18} {22}[103G{$13}▕{$7} {$8}▕{$7}";
          }
          {
            "type" = "weather";
            "location" = "Noida";
            "outputFormat" = "%t+-+%C+(%l)";
            "key" = "[38;2;114;241;184mWttr  ";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;114;241;184m▏[38;0m   [38;2;114;241;184m[38;0m";
            "format" = "{1}[103G{$13}{$6}{$7} {$8}{$6}{$7}";
          }
          {
            "type" = "custom";
            "key" = "[38;2;114;241;184mColors";
            "keyIcon" = "[38;2;54;248;236m▏[0m [38;2;114;241;184m▏[38;0m   [38;2;114;241;184m[38;0m";
            "format" = "{#90}  {#31}  {#32}  {#33}  {#34}  {#35}  {#36}  {#37}  {#38}  {#39}[102G{$13}{$1}{$7}{$8}{$1}{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}▏{$7} {$13}{$4}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$1}{$7}{$8}{$1}{$7}";
          }
          {
            "type" = "custom";
            "format" = "{$8}{$4}▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁{$1}{$7}";
