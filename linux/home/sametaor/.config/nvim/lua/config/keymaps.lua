...
vim.keymap.set("n", "<leader>a", ":Dashboard<CR>", { desc = "View Dashboard" })
-- Diagnostic keymaps
...
-- open terminal on new window
vim.api.nvim_set_keymap("n", "<leader>z", ":tabnew | terminal<CR>", { desc = "Open a new tab with a zsh terminal" })
