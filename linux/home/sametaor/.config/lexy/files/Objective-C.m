...
int main (int argc, const char * argv[])
{
    ...
    NSDictionary *numberDictionary = @{@"a": @1, @"b": @2};
...
@protocol CarUtilities  //  => Name of another protocol this protocol includes.
...
// Categories may implement protocols as well: @interface Car (CarCategory) 
// You may implement many protocols: @interface Car : NSObject 
...
- (void)beNiceToBrother:(id )brother;
