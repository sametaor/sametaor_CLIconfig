...
/////////////////// Find (Read) ////////////////////////
// Queries are in the form of db.collectionName.find()
// Where  is an object
...
///////////////////////// Update ////////////////////////
// Queries are in the form of db.collectionName.update(, )
// NOTE:  will always use the $set operator.
...
/////////////////////// Delete /////////////////////////
// Queries are in the form of db.collectionName.delete()
...
// NOTE: There are two methods db.collection.removeOne() and 
// db.collection.removeMany() that also delete objects but have a
