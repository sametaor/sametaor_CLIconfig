...
public class LearnJava {
    ...
    private static class TestInitialization {
        ...
        private static final Set COUNTRIES_DOUBLE_BRACE = 
        new HashSet() {{
            add("DENMARK");
            add("SWEDEN");
            add("FINLAND");
        ...
        private static final List COUNTRIES_AS_LIST = 
        ...
        // by creating another Collection from the List:
         private static final Set COUNTRIES_SET = 
    ...
    private static class TestJava11Initialization {
        ...
        private static final Set COUNTRIES_WITH_NULL = 
