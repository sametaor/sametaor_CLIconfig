...
echo 3  # 3
# echo '3'  # This errors, but could be caught with try/catch
...
command! -nargs=1 -complete=file MyCmd edit 
...
# Define a script-local function and map it via 
def DoSomething()
  echo 'Action triggered'
enddef

nnoremap  (MyPluginAction) DoSomething()
nmap  a (MyPluginAction)
...
# `expand({expr})` expands filenames, ``, etc.
echo expand('%:p')
